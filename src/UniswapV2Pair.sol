...
contract UniswapV2Pair is UniswapV2ERC20 {
    ...
    function getReserves() public view returns (uint112 _reserve0, uint112 _reserve1, uint32 _blockTimestampLast) {
        console.log("Pair: getReserves beginning");
        _reserve0 = reserve0;
        _reserve1 = reserve1;
        _blockTimestampLast = blockTimestampLast;
        console.log("Pair: getReserves returning", _reserve0, _reserve1, _blockTimestampLast);
    }
    ...
    function mint(address to) external lock returns (uint liquidity) {
        ...
        console.log("to", to, "liquidity", liquidity);
        _mint(to, liquidity);
    ...
    function swap_noFee(uint amount0Out, uint amount1Out, address to, bytes calldata data) external lock {
        require(amount0Out > 0 || amount1Out > 0, 'UniswapV2: INSUFFICIENT_OUTPUT_AMOUNT');
        (uint112 _reserve0, uint112 _reserve1,) = getReserves(); // gas savings
        require(amount0Out < _reserve0 && amount1Out < _reserve1, 'UniswapV2: INSUFFICIENT_LIQUIDITY');
